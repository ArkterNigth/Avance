...
const overviewData = [
	{ name: "Ganancia", value: "$1,234,567", change: 12.5, icon: DollarSign },
	{ name: "Usuarios", value: "45,678", change: 8.3, icon: Users },
	{ name: "Pedidos", value: "9,876", change: -3.2, icon: ShoppingBag },
	{ name: "Visitas de página", value: "1,234,567", change: 15.7, icon: Eye },
];
        ...
        '
            ...
            `}
					>
						...
						<span className='ml-2 text-sm text-gray-400'>vs último periodo</span>
					</div>
				</motion.div>
			))}
		</div>
